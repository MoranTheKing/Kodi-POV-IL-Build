...
device‑agnostic build config. **Do not commit generated or machine‑specific
files**, including:

- **`cpath_cache.db`** (FENtastic home‑view path cache) and any other `*.db` /
  cache files — regenerated per device.
