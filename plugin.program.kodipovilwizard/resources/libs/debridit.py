...
DEBRIDID = {
    ...
    'twilightrd': {
        ...
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.twilight', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'twilight_rd'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.twilight', 'settings.xml'),
        'default'  : 'rd.account_id',
        'data'     : ['rd.account_id', 'rd.token', 'rd.client_id', 'rd.refresh', 'rd.secret', 'rd.enabled'],
        'activate' : 'RunPlugin(plugin://plugin.video.twilight/?mode=real_debrid.authenticate)'},
    'twilightad': {
        'name'     : 'Twilight AD',
        'plugin'   : 'plugin.video.twilight',
        'saved'    : 'twilightad',
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.twilight', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.twilight', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'twilight_ad'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.twilight', 'settings.xml'),
