...
from resources.lib.subs_engine.general import extract_season_episode_numbers
...
import threading
import asyncio
telethon_dependencies = xbmc_tranlate_path('special://home/addons/service.subtitles.All_Subs/resources/modules/telethon_dependencies')
...
from telegram_api import api_id, api_hash, bot_token
...
def upload_subtitle_to_telegram(sub_file_to_upload,filename_to_upload,caption,source):
    ...
    from resources.lib.subs_engine.general import get_video_data
