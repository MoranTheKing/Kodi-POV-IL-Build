...
def show_results(show_dp=True):
    ...
    from resources.lib.subs_engine.general import with_dp
    show_dp=with_dp
    break_all=False
    ...
    if (show_dp):
        ...
        while(1):
            from resources.lib.subs_engine.general import show_msg
            if (show_msg!="END"):
...
def manual_search_for_imdb_id(video_data):
    ...
    # https://github.com/jurialmunkey/plugin.video.themoviedb.helper/blob/nexus/resources/tmdbhelper/lib/api/api_keys/tmdb.py#L5
