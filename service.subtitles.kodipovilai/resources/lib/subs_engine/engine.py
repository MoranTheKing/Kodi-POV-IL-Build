...
from resources.lib.subs_engine.sources import wizdom
from resources.lib.subs_engine.sources import telegram
from resources.lib.subs_engine.sources import opensubtitles
from resources.lib.subs_engine.sources import yify
from resources.lib.subs_engine.sources import subsource
from resources.lib.subs_engine.sources import subscene
from resources.lib.subs_engine.sources import bsplayer
...
def c_get_subtitles(video_data, all_lang_override=False):
    ...
    if not f_result and Addon.getSetting('retry_search_with_all_langs')=='true' and Addon.getSetting('all_lang')=='false' and not all_lang_override:
        if Addon.getSetting("enable_autosub_notifications")=='true':
            from resources.lib.subs_engine.general import notify
