...
NEW_BLOCK = (
    '    file_original_path = os.path.basename(file_original_path)\r\n'
    '            \r\n'
    '    ' + MARKER + ': detect hash-like basenames (TorBox style)\r\n'
    '    # and synthesise a release-name-like filename from metadata so\r\n'
    '    # the % matcher has tokens to compare against subtitle releases.\r\n'
    '    try:\r\n'
    '        if _ai_subs_filename_looks_like_hash(file_original_path):\r\n'
